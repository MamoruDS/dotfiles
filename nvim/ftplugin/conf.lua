...
if vim.fn.expand("%:p"):find("^/var/tmp") then
	-- TODO
	local fname = vim.fn.expand("%:p"):match(
		"^/var/tmp/(.*)%.[a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9]$"
	)
	if fname ~= nil then
	...
	local base, ext = vim.fn.expand("%:p"):match(
